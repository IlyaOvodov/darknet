...
void demobar(char *datacfg, char *cfgfile, char *weightfile, const char *filename,  float thresh, int cam_index, int frame_skip, char *prefix, char *out_filename, int http_stream_port, int dont_show);
